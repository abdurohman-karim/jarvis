...
// loaded command packs; replaced wholesale on reload, readers hold an Arc snapshot
pub static COMMANDS_LIST: Lazy<RwLock<Arc<Vec<JCommandsList>>>> = Lazy::new(|| RwLock::new(Arc::new(Vec::new())));
