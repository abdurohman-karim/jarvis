...
settings-ai-speak-desc = Читати відповідь уголос.
...
settings-tts-engine-desc = Заздалегідь згенеровані фрази — а це майже всі відповіді команд, зокрема час, дата й заряд, — завжди звучать голосом асистента. Рушій озвучує решту.
